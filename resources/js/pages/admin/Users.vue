...
async function submit() {
    ...
    try {
        ...
        const res = await fetch(
            editUser.value
                ? `/admin/users/${editUser.value.id}`
                : '/admin/users',
            {
                method: editUser.value ? 'PUT' : 'POST',
                headers,
...
<template>
        ...
        <div class="mb-5 flex items-center justify-between">
            <div>
                ...
                <p class="mt-0.5 text-sm text-muted-foreground">
                    {{ props.users.length }} user terdaftar
                </p>
            </div>
            <button
    ...
    <Teleport to="body">
        ...
        >
            <div
                class="w-full max-w-md rounded-xl border border-sidebar-border bg-card p-6 shadow-xl"
            >
                ...
                <form class="flex flex-col gap-4" @submit.prevent="submit">
                    ...
                    <p
                        v-if="error"
                        class="rounded bg-red-50 px-3 py-2 text-sm text-red-600 dark:bg-red-950/30"
                    >
                        {{ error }}
                    </p>
    ...
    <Teleport to="body">
        ...
        >
            <div
                class="w-full max-w-sm rounded-xl border border-sidebar-border bg-card p-6 shadow-xl"
            >
